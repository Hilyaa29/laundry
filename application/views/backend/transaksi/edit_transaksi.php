       ...
       <div class="card shadow mb-4">
            <div class="card-body">
                <form  method="post" action="<?= base_url()?>transaksi/update">
                    ...
                    <div class="form-group">
                       <input type="number" id="berat" name="berat" class="form-control" value="<?= $transaksi['berat'];?>" placeholder="Berat (KG)">
                    </div>

                    <div class="form-group">
                       <input type="number" id="grand_total" name="grand_total" class="form-control" value="<?= $transaksi['grand_total'];?>" placeholder="Grand Total"readonly>
                    </div>
